...
<div class="jumbotron" style="float: left; width:69%; padding:1rem; margin:0pt; background-color:#ffffff;">
    ...
    <div class="jumbotron" style="padding: 1rem; margin:0pt; margin-bottom:1rem;">
        ...
        <p style="margin:0pt;">2. Klik tombol <b>Buat Kelas</b></p>
        <p style="margin:0pt;">3. Masukkan nama kelas, token kelas, dan jumlah siswa</p>
        <p style="margin:0pt;">4. Klik tombol <b>Buat</b></p>
        <p style="margin:0pt;">5. Cek kelas pada tabel yang tersedia</p>
        <p style="margin:0pt;">6. Klik pada <b>Nama Kelas</b> untuk melihat rekomendasi pada kelas tersebut</p>
        <p style="margin:0pt;">7. Pada bagian aksi terdapat pilihan <b>Edit</b> untuk mengubah dan <b>Hapus</b> untuk menghapus kelas</p>
    </div>
...
<div class="jumbotron" style="float:left; width:29%; padding:1rem; margin:0pt; background-color:#ffffff;">
    ...
    <div class="jumbotron" style="padding: 1rem; margin:0pt; margin-bottom:1rem; text-align:center;">
        ...
        <p style="margin:0pt;">Kombinasi dari merasakan dan mengamati (feeling and watching)</p>
    </div>

    <div class="jumbotron" style="padding: 1rem; margin:0pt; margin-bottom:1rem; text-align:center;">
        <p style="margin:0pt;"><b>Asimilator</b></p>
        <p style="margin:0pt;">Kombinasi dari berpikir dan mengamati (thinking and watching)</p>
    </div>

    <div class="jumbotron" style="padding: 1rem; margin:0pt; margin-bottom:1rem; text-align:center;">
        <p style="margin:0pt;"><b>Konverger</b></p>
        <p style="margin:0pt;">Kombinasi dari berpikir dan melakukan (thinking and doing)</p>
    </div>

    <div class="jumbotron" style="padding: 1rem; margin:0pt; margin-bottom:1rem; text-align:center;">
        <p style="margin:0pt;"><b>Akomodator</b></p>
        <p style="margin:0pt;">Kombinasi dari perasaan dan melakukan (feeling and doing)</p>
    </div>
</div>
