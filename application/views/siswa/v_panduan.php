...
<div class="jumbotron" style="float: left; width:69%; padding:1rem; margin:0pt; background-color:#ffffff; font-family: Poppins;">
    ...
    <div class="jumbotron" style="padding: 1rem; margin:0pt; margin-bottom:1rem;">
        ...
        <p style="margin:0pt;">2. Klik tombol <b>Tambah Kelas</b></p>
        <p style="margin:0pt;">3. Klik tombol <b>Tambahkan</b></p>
        <p style="margin:0pt;">4. Cek kelas pada tabel yang tersedia</p>
    </div>
    ...
    <div class="jumbotron" style="padding: 1rem; margin:0pt; font-family: Poppins;">
        ...
        <p style="margin:0pt;">4. Kerjkan soal tes yang berjumlah 80 butir </p>
        <p style="margin:0pt;">5. Waktu pengerjaan tes selama 120 menit, tidak ada jawaban yang benar, isilah sesuai dengan pendapat masing-masing</p>
    </div>
</div>
